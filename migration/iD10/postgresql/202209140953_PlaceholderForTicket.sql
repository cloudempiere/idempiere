...
ALTER TABLE AD_ChartDatasource ADD COLUMN ChartType VARCHAR(2) DEFAULT 'BC' 
;
...
ALTER TABLE AD_ChartDatasource ADD COLUMN AD_Chart_Axis_Y VARCHAR(3) DEFAULT 'PRI' 
;
