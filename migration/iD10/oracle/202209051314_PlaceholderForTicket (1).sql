...
CREATE TABLE AD_Chart_Para (AD_Client_ID NUMBER(10) DEFAULT NULL )
;
...
ALTER TABLE AD_Chart_Para ADD AD_Chart_Para_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD AD_Org_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD Created DATE DEFAULT SYSDATE NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD CreatedBy NUMBER(10) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD Updated DATE DEFAULT SYSDATE NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD UpdatedBy NUMBER(10) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD Name VARCHAR2(60 CHAR) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD Description VARCHAR2(255 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_Chart_Para ADD Help VARCHAR2(2000 CHAR) DEFAULT NULL 
;
...
-- Sep 5, 2022, 2:24:08 PM CEST
ALTER TABLE AD_Chart_Para ADD AD_Chart_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD SeqNo NUMBER(10) NOT NULL
;
...
-- Sep 5, 2022, 2:26:22 PM CEST
ALTER TABLE AD_Chart_Para ADD AD_Reference_ID NUMBER(10) NOT NULL
;
...
-- Sep 5, 2022, 2:26:39 PM CEST
ALTER TABLE AD_Chart_Para ADD AD_Reference_Value_ID NUMBER(10) DEFAULT NULL 
;
...
-- Sep 5, 2022, 2:27:01 PM CEST
ALTER TABLE AD_Chart_Para ADD AD_Val_Rule_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE AD_Chart_Para ADD ColumnName VARCHAR2(30 CHAR) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD IsCentrallyMaintained CHAR(1) DEFAULT 'Y' CHECK (IsCentrallyMaintained IN ('Y','N')) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD IsMandatory CHAR(1) CHECK (IsMandatory IN ('Y','N')) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD IsRange CHAR(1) CHECK (IsRange IN ('Y','N')) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD DefaultValue VARCHAR2(2000 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_Chart_Para ADD DefaultValue2 VARCHAR2(2000 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_Chart_Para ADD VFormat VARCHAR2(40 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_Chart_Para ADD ValueMin VARCHAR2(20 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_Chart_Para ADD ValueMax VARCHAR2(20 CHAR) DEFAULT NULL 
;
...
-- Sep 5, 2022, 2:30:54 PM CEST
ALTER TABLE AD_Chart_Para ADD AD_Element_ID NUMBER(10) DEFAULT NULL 
;
...
-- Sep 5, 2022, 2:32:14 PM CEST
ALTER TABLE AD_Chart_Para ADD EntityType VARCHAR2(40 CHAR) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD ReadOnlyLogic VARCHAR2(2000 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_Chart_Para ADD DisplayLogic VARCHAR2(2000 CHAR) DEFAULT NULL 
;
...
-- Sep 5, 2022, 2:34:21 PM CEST
ALTER TABLE AD_Chart_Para ADD AD_Chart_Para_UU VARCHAR2(36 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_Chart_Para ADD IsEncrypted CHAR(1) CHECK (IsEncrypted IN ('Y','N')) NOT NULL
;
...
ALTER TABLE AD_Chart_Para ADD IsAutocomplete CHAR(1) DEFAULT 'N' CHECK (IsAutocomplete IN ('Y','N')) NOT NULL
;
...
-- Sep 5, 2022, 2:52:47 PM CEST
CREATE TABLE AD_ChartDatasource_Column (AD_ChartDatasource_Column_ID NUMBER(10) NOT NULL, AD_ChartDatasource_Column_UU VARCHAR2(36 CHAR) DEFAULT NULL , AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, Description VARCHAR2(255 CHAR) DEFAULT NULL , Help VARCHAR2(2000 CHAR) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AD_ChartDatasource_Column_Key PRIMARY KEY (AD_ChartDatasource_Column_ID), CONSTRAINT AD_ChartDatasource_Columnuuidx UNIQUE (AD_ChartDatasource_Column_UU))
;
...
-- Sep 5, 2022, 2:54:57 PM CEST
ALTER TABLE AD_ChartDatasource_Column ADD AD_ChartDatasource_ID NUMBER(10) NOT NULL
;
...
-- Sep 5, 2022, 2:55:29 PM CEST
ALTER TABLE AD_ChartDatasource_Column ADD AD_Chart_Para_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE AD_ChartDatasource_Column ADD SelectClause VARCHAR2(2000 CHAR) NOT NULL
;
