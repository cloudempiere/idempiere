...
-- Sep 28, 2022, 2:02:09 PM CEST
CREATE TABLE PA_Goal_Measure (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, Description VARCHAR2(255 CHAR) DEFAULT NULL , Help VARCHAR2(2000 CHAR) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, PA_Goal_ID NUMBER(10) NOT NULL, PA_Goal_Measure_ID NUMBER(10) NOT NULL, PA_Goal_Measure_UU VARCHAR2(36 CHAR) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT PA_Goal_Measure_Key PRIMARY KEY (PA_Goal_Measure_ID), CONSTRAINT PA_Goal_Measure_UU_idx UNIQUE (PA_Goal_Measure_UU))
;
...
ALTER TABLE PA_Goal_Measure ADD MeasureTarget NUMBER DEFAULT 0 NOT NULL
;
...
ALTER TABLE PA_Goal_Measure ADD MeasureActual NUMBER DEFAULT 0
;
...
ALTER TABLE PA_Goal_Measure ADD GoalPerformance NUMBER DEFAULT NULL 
;
...
ALTER TABLE PA_Goal_Measure ADD DateLastRun DATE DEFAULT NULL 
;
...
ALTER TABLE PA_Goal_Measure ADD GoalRelativeChange NUMBER DEFAULT NULL 
;
