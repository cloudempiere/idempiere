...
-- Sep 13, 2022, 2:00:17 PM CEST
CREATE TABLE PA_Goal_Set (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, Description VARCHAR2(255 CHAR) DEFAULT NULL , Help VARCHAR2(2000 CHAR) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, PA_Goal_Set_ID NUMBER(10) NOT NULL, PA_Goal_Set_UU VARCHAR2(36 CHAR) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT PA_Goal_Set_Key PRIMARY KEY (PA_Goal_Set_ID), CONSTRAINT PA_Goal_Set_UU_idx UNIQUE (PA_Goal_Set_UU))
;
...
-- Sep 13, 2022, 2:03:00 PM CEST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 100, getDate(), 100,t.AD_Tree_ID, 200214, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=200214)
;
...
-- Sep 13, 2022, 2:06:52 PM CEST
CREATE TABLE PA_Goal_Set_Assignment (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, Description VARCHAR2(255 CHAR) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, PA_Goal_ID NUMBER(10) NOT NULL, PA_Goal_Set_Assignment_ID NUMBER(10) NOT NULL, PA_Goal_Set_Assignment_UU VARCHAR2(36 CHAR) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT PA_Goal_Set_Assignment_Key PRIMARY KEY (PA_Goal_Set_Assignment_ID), CONSTRAINT PA_Goal_Set_Assignment_UU_idx UNIQUE (PA_Goal_Set_Assignment_UU))
;
...
-- Sep 13, 2022, 2:31:53 PM CEST
ALTER TABLE PA_Goal_Set_Assignment ADD PA_Goal_Set_ID NUMBER(10) NOT NULL
;
...
-- Sep 13, 2022, 2:37:16 PM CEST
ALTER TABLE PA_DashboardContent ADD PA_Goal_Set_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE PA_Goal_Set_Assignment ADD SeqNo NUMBER(10) NOT NULL
;
...
ALTER TABLE PA_Goal_Set_Assignment MODIFY PA_Goal_ID NUMBER(10)
;
