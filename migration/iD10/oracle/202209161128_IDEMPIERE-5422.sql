...
-- Sep 16, 2022, 11:31:13 AM CEST
CREATE TABLE PA_Goal_Trl (AD_Client_ID NUMBER(10) NOT NULL, AD_Language VARCHAR2(6 CHAR) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, IsTranslated CHAR(1) DEFAULT 'N' CHECK (IsTranslated IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, PA_Goal_ID NUMBER(10) NOT NULL, PA_Goal_Trl_UU VARCHAR2(36 CHAR) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT PA_Goal_Trl_UU_idx UNIQUE (PA_Goal_Trl_UU))
;
...
ALTER TABLE PA_Goal_Trl ADD Description VARCHAR2(255 CHAR) DEFAULT NULL 
;
...
ALTER TABLE PA_Goal_Trl ADD Note VARCHAR2(2000 CHAR) DEFAULT NULL 
;
