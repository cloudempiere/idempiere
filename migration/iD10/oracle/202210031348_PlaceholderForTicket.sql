...
-- Oct 3, 2022, 1:51:16 PM CEST
CREATE TABLE AD_Dashboard_Para (AD_Client_ID NUMBER(10) DEFAULT NULL , AD_Dashboard_Para_ID NUMBER(10) NOT NULL, AD_Dashboard_Para_UU VARCHAR2(36 CHAR) DEFAULT NULL , AD_Element_ID NUMBER(10) DEFAULT NULL , AD_Org_ID NUMBER(10) NOT NULL, AD_Reference_ID NUMBER(10) NOT NULL, AD_Reference_Value_ID NUMBER(10) DEFAULT NULL , AD_Val_Rule_ID NUMBER(10) DEFAULT NULL , ColumnName VARCHAR2(30 CHAR) NOT NULL, Created DATE DEFAULT SYSDATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, DefaultValue VARCHAR2(2000 CHAR) DEFAULT NULL , DefaultValue2 VARCHAR2(2000 CHAR) DEFAULT NULL , Description VARCHAR2(255 CHAR) DEFAULT NULL , DisplayLogic VARCHAR2(2000 CHAR) DEFAULT NULL , EntityType VARCHAR2(40 CHAR) NOT NULL, Help VARCHAR2(2000 CHAR) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, IsAutocomplete CHAR(1) DEFAULT 'N' CHECK (IsAutocomplete IN ('Y','N')) NOT NULL, IsCentrallyMaintained CHAR(1) DEFAULT 'Y' CHECK (IsCentrallyMaintained IN ('Y','N')) NOT NULL, IsEncrypted CHAR(1) CHECK (IsEncrypted IN ('Y','N')) NOT NULL, IsMandatory CHAR(1) CHECK (IsMandatory IN ('Y','N')) NOT NULL, IsRange CHAR(1) CHECK (IsRange IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, ReadOnlyLogic VARCHAR2(2000 CHAR) DEFAULT NULL , SeqNo NUMBER(10) NOT NULL, Updated DATE DEFAULT SYSDATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, VFormat VARCHAR2(40 CHAR) DEFAULT NULL , ValueMax VARCHAR2(20 CHAR) DEFAULT NULL , ValueMin VARCHAR2(20 CHAR) DEFAULT NULL , CONSTRAINT AD_Dashboard_Para_Key PRIMARY KEY (AD_Dashboard_Para_ID), CONSTRAINT AD_Dashboard_Para_UU_idx UNIQUE (AD_Dashboard_Para_UU))
;
...
-- Oct 3, 2022, 1:53:04 PM CEST
CREATE TABLE AD_Dashboard_Para_Trl (AD_Client_ID NUMBER(10) NOT NULL, AD_Dashboard_Para_ID NUMBER(10) NOT NULL, AD_Dashboard_Para_Trl_UU VARCHAR2(36 CHAR) DEFAULT NULL , AD_Language VARCHAR2(6 CHAR) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, IsTranslated CHAR(1) DEFAULT 'N' CHECK (IsTranslated IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AD_Dashboard_Para_Trl_UU_idx UNIQUE (AD_Dashboard_Para_Trl_UU))
;
